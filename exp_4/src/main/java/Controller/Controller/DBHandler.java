...
public class DBHandler {
    ...
    public static Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/college", "root", "jenish@123");
        return connection;
    }
    ...
    public static List<Student> list() throws ClassNotFoundException, SQLException {
